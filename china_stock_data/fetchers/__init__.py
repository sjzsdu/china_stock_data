...
from .market import MarketSentimentFetcher, LHBFetcher, MarginFinancingFetcher, NorthboundHoldingsFetcher
...
market_fetchers = [MarketSentimentFetcher, LHBFetcher, MarginFinancingFetcher, NorthboundHoldingsFetcher]
